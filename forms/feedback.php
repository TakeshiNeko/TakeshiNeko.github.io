<meta http-equiv='refresh' content='3; url=https://kolganovsm.site'>
<meta charset="UTF-8" />
<?php
	...
	$address = "job.mail.v001@gmail.com";//адрес куда будет отсылаться сообщение для администратора
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Сообщение отправлено успешно! Перейти на <a href='https://kolganovsm.site'>сайт</a>, если вас не перенаправило вручную.";
	else 
